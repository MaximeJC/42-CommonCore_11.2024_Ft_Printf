...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/10/28 15:47:33 by mgouraud          #+#    #+#             */
/*   Updated: 2024/12/02 14:51:28 by mgouraud         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	ft_prtformat(char c, va_list args)
{
	...
	{
		ft_putstr_fd("/!\\ WARNING: One argument not corresponding", 2);
		ft_putstr_fd(" to a known % type /!\\", 2);
	}
	return (0);
}
